...
from lynx_code.util import print_msg, create_and_start_event_loop
from lynx_code.synchronizer import SynchronizerBase


try:
    addr = sys.argv[1]
except Exception:
    print("usage: watch_address <audax_address>")
    sys.exit(1)
