...
from lynx_code.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from lynx_code.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                                   is_address)
from lynx_code.bip32 import BIP32Node
from lynx_code import ecc
from lynx_code.ecc import msg_magic
from lynx_code.wallet import Standard_Wallet
from lynx_code import constants
from lynx_code.transaction import Transaction
from lynx_code.i18n import _
from lynx_code.keystore import Hardware_KeyStore
from ..hw_wallet import HW_PluginBase
from lynx_code.util import to_string, UserCancelled, UserFacingException
from lynx_code.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from lynx_code.network import Network
from lynx_code.logging import get_logger
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("AUDAX-Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
