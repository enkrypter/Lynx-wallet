...
from lynx_code.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
...
from lynx_code.util import bfh, bh2u, versiontuple, UserFacingException
from lynx_code.base_wizard import ScriptTypeNotSupported
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in audax mode")) from e
                raise e
