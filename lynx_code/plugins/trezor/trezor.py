...
from lynx_code.util import bfh, bh2u, versiontuple, UserCancelled, UserFacingException
from lynx_code.bitcoin import TYPE_ADDRESS, TYPE_SCRIPT
from lynx_code.bip32 import BIP32Node, convert_bip32_path_to_list_of_uint32 as parse_path
from lynx_code import constants
from lynx_code.i18n import _
from lynx_code.plugin import Device
from lynx_code.transaction import deserialize, Transaction
from lynx_code.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "AUDAX Testnet" if constants.net.TESTNET else "AUDAX"
